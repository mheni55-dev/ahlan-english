    ...
    <section className="py-20 sm:py-28 bg-white dark:bg-navy-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 rounded-full bg-gold/10 text-gold text-sm font-bold mb-4">{t("testimonials.badge", lang)}</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-navy dark:text-white mb-4">
            {t("testimonials.title", lang)} <span className="text-gold">{t("testimonials.titleHighlight", lang)}</span>
          </h2>
